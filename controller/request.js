...
const nextField = {
    ...
    SELL_TREASURY_FEE: "BUY_FEE_LIMIT",
    BUY_FEE_LIMIT: "SELL_FEE_LIMIT",
    SELL_FEE_LIMIT: "OPERATING_ADDRESS",
...
const nextMsg = {
    ...
    TRADING_BLOCK_LIMIT: "TRANSFER_LIMIT",   
    TRANSFER_LIMIT:  "Please enter max buy  percentage of supply without %  (Please enter in multiples of 100 for e.g. 100 for 1% ,150 for 1.5% and so on)",
