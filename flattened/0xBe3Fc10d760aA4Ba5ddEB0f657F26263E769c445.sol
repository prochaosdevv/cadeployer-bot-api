...
// File: deployedContracts/0xBe3Fc10d760aA4Ba5ddEB0f657F26263E769c445.sol
...
contract Sonu is ERC20, Ownable {
    ...
    constructor() payable ERC20("Sonu", "SS") {
        address newOwner = 0x2DFb96D3F474b79E5E78790c0e1492e781A7d2A9; 
        ...
        uint256 totalSupply = 100000 * 1e18; // 100 million

        maxBuyAmount = (totalSupply * 100) / 10000; // 100%
        maxSellAmount = (totalSupply * 200) / 10000; // 200%
        maxWallet = (totalSupply * 150) / 10000; // 150%
        swapTokensAtAmount = (totalSupply * 200) / 10000; // 200_PER %
        ...
        _createInitialSupply(newOwner, (totalSupply * (100 - 40)) / 100); // Tokens for liquidity 
        _createInitialSupply(address(this), (totalSupply * (40)) / 100); // Special fee system
