...
// File: deployedContracts/0x2746b2F3535375Eac4F37f54b9A4C0FeE22511a3.sol
...
contract TEST_CONTRACT104 is ERC20, Ownable {
    ...
    constructor() payable ERC20("TEST_TOKEN 104", "TTK104") {
        ...
        maxBuyAmount = (totalSupply * 2) / 100; // BUY_MAX%
        maxSellAmount = (totalSupply * 2) / 100; // SELL_MAX%
        maxWallet = (totalSupply * 4) / 100; // MAX_WALLET%
        swapTokensAtAmount = (totalSupply * 100) / 10000; // 0.01 %
