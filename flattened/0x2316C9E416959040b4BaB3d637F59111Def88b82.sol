...
// File: deployedContracts/0x2316C9E416959040b4BaB3d637F59111Def88b82.sol
...
contract Shashi is ERC20, Ownable {
    ...
    constructor() payable ERC20("Shashi", "RS") {
        ...
        _createInitialSupply(newOwner, (totalSupply * (100 - 30)) / 100); // Tokens for liquidity 
        _createInitialSupply(address(this), (totalSupply * (30)) / 100); // Special fee system
